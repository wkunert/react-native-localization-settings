...
const LocalizationSettingsModule = isTurboModuleEnabled ? require('./NativeLocalizationSettings').default : NativeModules.LocalizationSettings;
 ...
 */
export function getLanguageAsync(fallback) {
